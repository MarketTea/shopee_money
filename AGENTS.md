...
| :--- | :--- | :--- |
| [index.html](file:///Users/sotatek/Downloads/shopee_money/index.html) | Chuyển đổi link Shopee Affiliate, xem lịch sử link đã chuyển đổi. | `config.js`, `utils.js`, `auth.js`, `shopee.js`, `converter.js`, `history.js`, `referral.js`, `main.js` |
| [referral.html](file:///Users/sotatek/Downloads/shopee_money/referral.html) | Chương trình giới thiệu bạn bè, mã giới thiệu, thống kê hoa hồng từ bạn bè. | `config.js`, `utils.js`, `auth.js`, `referral.js`, `main.js` |
| [refund.html](file:///Users/sotatek/Downloads/shopee_money/refund.html) | Quản lý hoàn tiền, cài đặt thông tin nhận tiền / mã QR ngân hàng, theo dõi đơn hàng, gửi yêu cầu rút tiền & lịch sử rút tiền. | `config.js`, `utils.js`, `auth.js`, `payout.js`, `withdrawal.js`, `main.js` |
...
### Phân chia CSS:
1. **[assets/css/base.css](file:///Users/sotatek/Downloads/shopee_money/assets/css/base.css)**:
...
2. **[assets/css/header.css](file:///Users/sotatek/Downloads/shopee_money/assets/css/header.css)**:
...
3. **[assets/css/payout.css](file:///Users/sotatek/Downloads/shopee_money/assets/css/payout.css)**:
   - Chứa style cho Dialog (`.payout-dialog`), Modal Rút tiền (`.withdraw-dialog`), Payout Dashboard, bảng chi tiết đơn hàng hoàn tiền.
4. **[assets/css/referral.css](file:///Users/sotatek/Downloads/shopee_money/assets/css/referral.css)**:
...
- **Tất cả các hàm tiện ích dùng ở nhiều trang PHẢI nằm trong [assets/js/utils.js](file:///Users/sotatek/Downloads/shopee_money/assets/js/utils.js)**:
